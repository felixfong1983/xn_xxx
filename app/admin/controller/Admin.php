...
class Admin extends AdminBase
{
    ...
    public function add()
    {
            ...
            if( $insert_id ) {
                if( !empty($param['group_ids']) ) {
                    foreach ($param['group_ids'] as $group_id) {
                        AuthGroupAccessModel::create(['admin_id'=>$insert_id,'group_id'=>$group_id]);
                    }
                }
        ...
        $group_data = AuthGroupModel::select();
        ...
        if( $this->request->isPost() ) {
            ...
            if( !empty($group_ids) ) {
                ...
                foreach( $group_ids as $group_id ) {
                    AuthGroupAccessModel::create(['admin_id'=>$id,'group_id'=>$group_id]);
                }
            }
